...
**고성능 오디오 시각화 및 AI 사운드 분석 오버레이 엔진**

</div>

<br/>

> **Sound Visualizer**는 실시간으로 시스템 오디오를 캡처하여 그래픽 오버레이로 변환합니다. WPF로 제작되어 게임 중에도 최적의 성능을 발휘하며, YAMNet과 ONNX Runtime을 기반으로 한 AI 사운드 분류기를 탑재해 총소리, 음성, 배경음 등의 오디오 이벤트를 지능적으로 감지합니다.

---

## 🌟 사회적 가치 및 기대 효과

이 프로젝트는 단순한 시각적 장식을 넘어, 청각과 시각의 세계를 이어줌으로써 다양한 사용자 층에 유의미한 가치를 제공합니다.

### 🦻 청각 장애인 및 난청 사용자를 위해
- **보이지 않는 것을 시각화**: 게임 내의 발소리, 총소리 또는 시스템 알림음과 같은 중요한 청각적 신호를 즉각적인 시각적 피드백으로 변환합니다.
- **게임의 공평성 제공**: 청각 장애 게이머도 오디오 기반의 게임 플레이 요소(공간감 및 이벤트)를 시각적으로 인지하여 동등한 수준에서 반응할 수 있도록 돕습니다.
...
- **실시간 분류 기능**: 소프트웨어에 내장된 `SoundClassifier` 모델이 배경음(Ambient), 음성(Speech), 위험/총소리(Danger/Gunshots) 등의 오디오 이벤트를 빠르게 감지하고 라벨링합니다.
- **직관적인 시각 피드백**: 각 감지 카테고리마다 사용자 지정 UI 색상을 할당하여 즉각적이고 직관적으로 상황을 인지할 수 있습니다.
...
---
<div align="center">
  <sub>접근성 향상과 몰입감 넘치는 디지털 경험을 위해 ❤️를 담아 만들어졌습니다.</sub>
</div>